...
public class TabDFm_web extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.tab_d_web, container, false);
    }
    ...
    public void showProgressDialog() {
        if (dialog == null)
            dialog = ProgressDialog.show(TabDFm_web.this.getActivity(), "加载中...", "正在加载数据。。。。，请稍后！", false, true);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
         O2OLoginActivity.wb = (WebView) this.getActivity().findViewById(R.id.web_d);
...
//配置权限
         O2OLoginActivity.wb.setWebChromeClient(new WebChromeClient() {
            ...
            public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
             ...
             O2OLoginActivity.wb.loadUrl("http://www.etouchme.com:89/mobile/index.php?m=category&a=service");
